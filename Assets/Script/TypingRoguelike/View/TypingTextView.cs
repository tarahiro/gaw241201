...
namespace gaw241201.View
{
    ...
    Vector2.right * _tmpQuestion.preferredWidth * (-0.5f + ((float)index) / _tmpQuestion.GetParsedText().Length));
        ...
        {
            //fake èâä˙âªèàóùÇÇøÇ·ÇÒÇ∆é¿ëïÇµÇΩÇ¢ SampleTextÉZÉbÉgÇ∑ÇÈÇ∆Ç±Ç∆Ç©Ç…
            Show();
            _tmpSample.text = s;
        }
        ...
        {  //ñ‚ëËï∂éöóÒÇUntypedÇ∆typedÇ…ï™ÇØÇÈ
            ...
            //ó^Ç¶ÇÁÇÍÇΩï∂éöóÒÇï ÇÃï∂éöóÒÇ…íuÇ´ä∑Ç¶ÇÈèàóù
