...
namespace gaw241201.Inject
{
    public class ProjectLifetimeScope : LifetimeScope
    {
        ...
        {
            Log.Comment("ProjectLifetimeScopeÇÃìoò^äJén");
            ...
            //à»â∫ÅAÉçÅ[ÉOÉâÉCÉNÇ©ÇÁà⁄êAÇµÇƒÇ´ÇΩÇ‡ÇÃ
        ...
        void CofigureManager(IContainerBuilder builder)
        {
            ...
            builder.Register<SimpleLoopStarter>(Lifetime.Singleton).AsSelf().WithParameter(FlowMasterConst.FlowMasterLabel.RealLeftEyeFlow);
